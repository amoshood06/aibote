    ...
    <!--login-->
        <div class="min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8">
                <div class="mt-6 sm:mt-8 lg:mt-12 bg-white p-8 rounded-[50px]">
                    ...
                    <p class="text-gray-600 text-sm sm:text-base mb-6 sm:mb-8">Sign up and get started</p>

                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"  class="space-y-4 sm:space-y-6">
                        <div>
                            <label for="full_name" class="block text-sm text-gray-600 mb-1.5 sm:mb-2">Full name</label>
                            <input type="text" id="full_name" name="full_name" class="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl border border-gray-200 focus:ring-2 focus:ring-amber-200 focus:border-amber-400 outline-none transition text-sm sm:text-base" placeholder="Amélie Laurent">
                        </div>
                    ...
                    <div class="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 text-xs sm:text-sm">
                        <p class="text-gray-600">
                            Have any account? <a href="login.php" class="text-black hover:underline">Sign in</a>
                        </p>
                        <a href="#" class="text-gray-600 hover:underline">Terms & Conditions</a>
                    </div>
                </div>
            <div class="hidden lg:block w-[400px] justify-center items-center p-8">
                <!--image-->
                <img src="assets/image/pngwing.com (17).png" alt="" class="w-[400px] animate-bounce">
            </div>
        </div>
